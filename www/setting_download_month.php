...
<form action="dump_csv.php" method="get">
    ...
    <div id="unit-switch">
        ...
        <a href="setting_download_month.php" class="active" id="unit-month">月間</a>
    ...
    <span id="fm">期間</span><input type="text" name="ymd" id="datepicker_month">
	</div>
