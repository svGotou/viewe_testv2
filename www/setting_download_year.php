...
.select-box label:after {
	...
	height: 20px;
	margin-top: -8px;
	background: url(viewe/images/arrow.png) 0 0 no-repeat;
...
<form action="dump_csv.php" method="get">
    ...
    <div id="unit-switch">
        <a href="setting_download_year.php" class="active" id="unit-year">年間</a>
        <a href="setting_download_month.php"id="unit-month">月間</a>
        <a href="setting_download_day.php"id="unit-day">１日</a>
	</div>

	<div class="select-box" id="kikan-from">
    <span class="small_text">集計データを取得したい期間を選択してください。</span><br>
    <span id="fm">期間</span>
	<label>
	<select id="id_year" name="ymd" class="pull-down" ></select>
    </label>
	</div>
